...
while cap.isOpened():
    ...
    if result.pose_landmarks:
        ...
        shoulder_scrunch_score = max(0, 1 - ((180 - angle) / 145))

        shoulders_z = (left_shoulder_3d[2] + right_shoulder_3d[2]) / 2
        nose_z = nose_3d[2]
...
if frame_count > 0:
    final_head_tilt_score = total_head_tilt_score / frame_count
